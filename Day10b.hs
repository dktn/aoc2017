...
inputNorm :: (Int, String) -> (Int, [Int])
inputNorm (size, str) = (size, fmap ord str ++ addL)

-- I give up -- to much time to solve
-- calc64 :: Int -> [Int] -> Int
-- calc64 size l = 0
--   where
--     x = scanl red (State size 0 0 list, l) [0 .. 63]
--     red (s, l) i = (process s l, l)
--     list = [0 .. (size - 1)]
...
runTwo :: IO ()
runTwo = print $ uncurry calc $ inputNorm input
